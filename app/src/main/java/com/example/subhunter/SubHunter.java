...
/*
    ...
    the code for one-time setup phase
*/
 ...
 */
   public void newGame(){
    ...
    void draw(){
        ...
        for (int i = 0;i < gridWidth; i ++) {
            canvas.drawLine(blockSize * i, 0,
                    blockSize * i, numberVerticalPixels - 1, paint);
        }
        // Draw the horisontal lines of the grid
    ...
    public boolean onTouchEvent(MotionEvent motionEvent){
        ...
        // Has the player removed their firnger from the screen?
    ...
    private void takeShot(float touchX, float touchY){
        ...
        // How far away horizontally and vertivally
    ...
    void printDebuggingText(){
        ...
        canvas.drawText("subHorizontalPosition = " +
                ...
                blockSize * 10, paint);
        canvas.drawText("subVerticalPosotion = " +
